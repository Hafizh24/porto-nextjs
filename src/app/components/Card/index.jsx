...
const CustomCard = (props) => {
  const { title, description, image, icon1, icon2, icon3, url_preview, url_github } =
    props
  return (
    <div key={title} className="w-2/5 rounded-xl bg-white p-4 shadow">
      <Image
        src={image}
        alt={title}
        width={700}
      ...
      />
      <h3 className="mb-3 mt-5 text-xl font-semibold text-dark">{title}</h3>
      ...
      <div className=" flex justify-between">
        ...
        <div className=" flex items-center">
          <Link
            ...
            <svg
              className="w-7 fill-current text-dark"
              viewBox="0 0 24 24"
